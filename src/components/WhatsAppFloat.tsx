...
const WhatsAppFloat = () => {
  const handleWhatsAppClick = () => {
    window.open(
      "https://wa.me/5513991497873?text=Oi! Quero conhecer as soluções da Orbitha",
      "_blank",
      "noopener,noreferrer"
    );
  };
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 rounded-full shadow-lg transition-all duration-300 hover:scale-110 group"
